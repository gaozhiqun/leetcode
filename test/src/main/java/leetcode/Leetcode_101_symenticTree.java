 ...
 */
public class Leetcode_101_symenticTree {
    ...
    public static void main(String[] args) {
        Leetcode_101_symenticTree l = new Leetcode_101_symenticTree();
        ...
        node01.left = node33;
        node01.right = node04;
        System.out.println(l.sumNumbers(root1));
        ...
        node2.next = node3;
        node3.next = node4;
        int[] ret = l.nextLargerNodes(node0);
