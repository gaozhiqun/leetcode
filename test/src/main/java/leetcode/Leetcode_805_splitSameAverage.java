 ...
 */
public class Leetcode_805_splitSameAverage {

    public static void main(String[] args) {
        Leetcode_805_splitSameAverage l = new Leetcode_805_splitSameAverage();
        System.out.println(l.splitArraySameAverage(new int[]{1, 2, 3, 4, 5, 6, 7, 8}));
    }
